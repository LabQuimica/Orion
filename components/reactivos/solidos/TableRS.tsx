...
import { fetchReactivosSolidos } from "./fetching/selectRS";
import {
  createColumnHelper,
  getCoreRowModel,
  useReactTable,
...
const columnHelper = createColumnHelper<ReactivosSolidos>();
...
const TableRS = () => {
  ...
  useEffect(() => {
    const getdata = async () => {
      const valores = await fetchReactivosSolidos();
      setData(valores);
